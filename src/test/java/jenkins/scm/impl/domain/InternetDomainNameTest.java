 ...
 *
 * <p>Adapted from Guava 31.0.1. This should be switched to upstream when it is no longer beta.
 *
 * @author Craig Berry
 */
public final class InternetDomainNameTest extends TestCase {
  ...
  private static final String ALMOST_TOO_MANY_LEVELS =
      String.join("", Collections.nCopies(127, "a."));

  private static final String ALMOST_TOO_LONG =
      String.join("", Collections.nCopies(40, "aaaaa.")) + "1234567890.c";
  ...
  private static final Set<String> PS_NOT_RS =
      new HashSet<>(Arrays.asList("blogspot.com", "blogspot.co.uk", "uk.com"));
  ...
  private static final Set<String> NO_PS =
      new HashSet<>(Arrays.asList("www", "foo.ihopethiswillneverbeapublicsuffix", "x.y.z"));
  ...
  private static final Set<String> TOP_UNDER_REGISTRY_SUFFIX =
      new HashSet<>(Arrays.asList("google.com", "foo.Co.uk", "foo.ca.us."));

  private static final Set<String> TOP_PRIVATE_DOMAIN =
      new HashSet<>(Arrays.asList("google.com", "foo.Co.uk", "foo.ca.us.", "foo.blogspot.com"));

  private static final Set<String> UNDER_TOP_UNDER_REGISTRY_SUFFIX =
      new HashSet<>(Arrays.asList("foo.bar.google.com", "a.b.co.uk", "x.y.ca.us"));

  private static final Set<String> UNDER_PRIVATE_DOMAIN =
      new HashSet<>(
          Arrays.asList("foo.bar.google.com", "a.b.co.uk", "x.y.ca.us", "a.b.blogspot.com"));

  private static final Set<String> VALID_IP_ADDRS =
      new HashSet<>(Arrays.asList("1.2.3.4", "127.0.0.1", "::1", "2001:db8::1"));
  ...
  public void testInvalidTopPrivateDomain() {
    Set<String> badCookieDomains = new HashSet<>(Arrays.asList("co.uk", "foo", "com"));
  ...
  public void testIsValid() {
    final Set<String> validCases = new HashSet<>();
    validCases.addAll(VALID_NAME);
    validCases.addAll(PS);
    validCases.addAll(NO_PS);
    validCases.addAll(NON_PS);
    final Set<String> invalidCases = new HashSet<>();
    invalidCases.addAll(INVALID_NAME);
    invalidCases.addAll(VALID_IP_ADDRS);
    invalidCases.addAll(INVALID_IP_ADDRS);
