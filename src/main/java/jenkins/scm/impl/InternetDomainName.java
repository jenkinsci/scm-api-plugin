 ...
 * @since 5.0
 *
 * Taken without change from Guava 30.1 Used only internal to this plugin. Marked as restricted to prevent any further usages.
 * This should be switched to upstream when it is no longer beta.
 */
@Beta
